<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 表格区域 -->
      <el-table :data="orderlist" Boolean border>
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
        :current-page="queryInfo.pagenum" :page-sizes="[2, 4, 6, 8, 10]"
...
<!--            <el-input v-model="addressForm.city1">-->
<!--            </el-input>-->
            <el-cascader v-model="addressForm.city1" :options="cityData">
            </el-cascader>
          </el-form-item>
          <el-form-item label="详细地址" prop="city2">
            <el-input v-model="addressForm.city2">
            </el-input>
          </el-form-item>
        </el-form>
...
export default {
  data () {
    return {
      ...
      addressFormRules: {
        city1: [{ required: true, message: '请选择省市区县', trigger: 'blur' }],
        city2: [{ required: true, message: '请填写详细地址', trigger: 'blur' }]
      },
      cityData: cityData, // 属性名和属性重名可以直接简写 cityData
      // 物流信息数据
      progressInfo: []
    }
  },
